// GENERATED by src/gen-cst-match.ts — do not edit. Per-arm CST destructurers for "typescript".
/* eslint-disable */
...
function _Expr$lt(c: readonly CstChild[], src: string): ExprMatch | null {
  ...
  i++;
  if (i !== c.length) return null;
  return { arm: "lt", type: type!, expr: expr! };
}
...
export function matchExpr(n: ExprNode, src: string): ExprMatch {
  ...
  if (k0 === undefined) {
    ...
    switch (src.charCodeAt(k0.offset)) {
      ...
      case 60: {
        { const m = _Expr$lt(c, src); if (m !== null) return m; }
        break;
      }
      case 91: {
