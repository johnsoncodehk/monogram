...
export type ExprMatch =
  ...
  | { arm: "async3"; asyncTok?: CstLeaf; ident?: CstLeaf; param: (ParamNode)[]; block: BlockNode }
...
function _Expr$async3(c: readonly CstChild[], src: string): ExprMatch | null {
  ...
  i++;
  if (i !== c.length) return null;
  return { arm: "async3", asyncTok, ident, param, block: block! };
}
