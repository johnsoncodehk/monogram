...
static const char *RAW_TAGS[] = { "script", "style", "textarea", "title" };
static const unsigned RAW_TAG_COUNT = 4;
...
void *tree_sitter_html_external_scanner_create(void) { return 0; }
void tree_sitter_html_external_scanner_destroy(void *p) { (void)p; }
unsigned tree_sitter_html_external_scanner_serialize(void *p, char *b) { (void)p; (void)b; return 0; }
void tree_sitter_html_external_scanner_deserialize(void *p, const char *b, unsigned n) { (void)p; (void)b; (void)n; }
