...
_Each hand-written **official** grammar vs Monogram's **derived** one, on the bugs filed against it: **TypeScript 24/27** (official 9/27) · **TSX 9/11** (official 6/11) · **HTML 16/20** (official 14/20) · **Vue 16/19** (official 15/19). Per-issue detail below — auto-generated by `npm run bench:issues`._
