...
_Each hand-written **official** grammar vs Monogram's **derived** one, on the bugs filed against it: **TypeScript 27/27** (official 9/27) · **TSX 11/11** (official 6/11) · **HTML 20/20** (official 13/20) · **Vue 20/20** (official 16/20). Per-issue detail below — auto-generated by `npm run bench:issues`._
